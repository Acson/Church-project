...
<div class="archive">
 		...
 		<h3><?php printf( __( 'Articles By:  %s', 'wpzoom' ), "<strong><a href='$authordata->user_url' title='$authordata->display_name' rel='me'>$authordata->display_name</a></strong>" ) ?> <?php echo get_avatar( get_the_author_id() , 60 ); ?></h3>
		...
		<div class="post">
			...
			<span class="meta"> <?php if ($wpzoom_archive_date == 'Show') { ?><?php the_time("$dateformat $timeformat"); ?><?php } ?> <?php edit_post_link( __('Edit', 'wpzoom'), ' ', ''); ?></span>
 			<?php the_excerpt(); ?>
		</div>
