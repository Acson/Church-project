		...
		<textarea name="comment" id="comment" tabindex="1" rows="10" cols="140"></textarea><br />
			...
			<?php else : ?>
				...
				<div id="formLabels">
					...
					<p><input type="text" onblur="if (this.value == '') {this.value = '<?php _e('Name (required)', 'wpzoom') ?>';}" onfocus="if (this.value == '<?php _e('Name (required)', 'wpzoom') ?>') {this.value = '';}" value="<?php _e('Name (required)', 'wpzoom') ?>" name="author" id="author" value="<?php echo $comment_author; ?>" size="4" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> /></p>

 					<p><input type="text" onblur="if (this.value == '') {this.value = '<?php _e('Email (will not be published)', 'wpzoom') ?>';}" onfocus="if (this.value == '<?php _e('Email (will not be published)', 'wpzoom') ?>') {this.value = '';}" value="<?php _e('Email (will not be published)', 'wpzoom') ?>" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="4" tabindex="3" <?php if ($req) echo "aria-required='true'"; ?> /> </p>

 					<p class="last"><input type="text" onblur="if (this.value == '') {this.value = '<?php _e('Website', 'wpzoom') ?>';}" onfocus="if (this.value == '<?php _e('Website', 'wpzoom') ?>') {this.value = '';}" value="<?php _e('Website', 'wpzoom') ?>" name="url" id="url" value="<?php echo $comment_author_url; ?>" size="4" tabindex="4" /></p>
			...
			<div id="formContent">
				...
				<input name="submit" type="submit" id="submit" class="comm-submit" value="<?php _e('Submit Comment', 'wpzoom') ?>" />
			</div>
