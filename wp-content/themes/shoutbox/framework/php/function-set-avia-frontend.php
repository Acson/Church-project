...
if(!function_exists('avia_is_dynamic_template'))
{
	...
	*/
	...
	function avia_is_dynamic_template($id = false)
	{
		$result = false;
	...
	*/
	function avia_pagination($pages = '')
	{
		...
		if(1 != $pages)
		{
			...
			$output .= ($paged > 2 && $paged > $range+1 && $showitems < $pages)? "<a href='".get_pagenum_link(1)."'>&laquo;</a>":"";
			$output .= ($paged > 1 && $showitems < $pages)? "<a href='".get_pagenum_link($prev)."'>&lsaquo;</a>":"";
			...
			$output .= ($paged < $pages && $showitems < $pages) ? "<a href='".get_pagenum_link($next)."'>&rsaquo;</a>" :"";
			$output .= ($paged < $pages-1 &&  $paged+$range-1 < $pages && $showitems < $pages) ? "<a href='".get_pagenum_link($pages)."'>&raquo;</a>":"";
			$output .= "</div>\n";
		}
