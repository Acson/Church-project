<div id="page-nav">
    <div class="col-full">
        <div class="home-icon"><a href="<?php bloginfo('url'); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/ico-home.png" class="ico-home" alt="<?php _e('Home', 'woothemes'); ?>" /></a></div>
